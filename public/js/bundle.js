...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYnVpdHJ1eWVuIiwiYSI6ImNrODBibXkzZTBkcXUzZG80ZHYzaGVub2EifQ.pYI_AWxVLA6QJA6UIWz5bw';
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"searchImages.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_XRxH6nZgGCTTDEEwXmdpBtf6002F5J3NNg');
...
var searchForm = document.querySelector('.form__upload_search');
...
if (commentForm) commentForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var rating = document.querySelectorAll('.rated').length;
