...
exports.isCheckBuyTour = catchAsync(async (req, res, next) => {
  ...
  const isExit = await Booking.findOne({
    $and: [{ tour: tourObj.id }, { user: req.user._id }]
  });
...
exports.getMonthlyPlan = catchAsync(async (req, res, next) => {
  ...
  const plan = await Tour.aggregate([
    {
      //Trích xuất các phần tử trong mạng đưa nó ra ngoài thôi, https://www.w3resource.com/mongodb/aggregation/mongodb-aggregatrion-unwind-operator.php
      $unwind: '$startDates'
    },
    {
      $match: {
